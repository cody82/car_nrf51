 ...
 */
static void on_connect(ble_car_t * p_nus, ble_evt_t * p_ble_evt)
{
 ...
 * @param[in] p_ble_evt Pointer to the event received from BLE stack.
 */
static void on_disconnect(ble_car_t * p_nus, ble_evt_t * p_ble_evt)
{
 ...
 * @param[in] p_ble_evt Pointer to the event received from BLE stack.
 */
static void on_write(ble_car_t * p_nus, ble_evt_t * p_ble_evt)
{
 ...
 */
static uint32_t rx_char_add(ble_car_t * p_nus, const ble_car_init_t * p_nus_init)
{
 ...
 * @return NRF_SUCCESS on success, otherwise an error code.
 */
static uint32_t tx_char_add(ble_car_t * p_nus, const ble_car_init_t * p_nus_init)
{
    ble_gatts_char_md_t char_md;
    ble_gatts_attr_t    attr_char_value;
    ble_uuid_t          ble_uuid;
